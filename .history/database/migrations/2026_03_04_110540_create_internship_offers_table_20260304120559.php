...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('internship_offers', function (Blueprint $table) {
            ...
            // ─── Offer Info ────────────────────────────────────
            $table->string('title');                        // e.g. "Full Stack Developer Intern"
            $table->text('description');                    // full offer description
            $table->string('domain');                       // e.g. "Web Dev", "Data Science"
            $table->string('location');                     // wilaya / city
            $table->enum('type', [
                'présentiel',
                'télétravail',
                'hybride',

...
class AdminValidatedApplicationNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'kind' => 'admin_application_validated',
            ...
            'message' => 'The administration validated this accepted application.',
        ];
    }
}
